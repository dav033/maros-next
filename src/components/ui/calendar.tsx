  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        weekday: cn(
          "text-muted-foreground w-[var(--cell-size)] shrink-0 select-none rounded-md text-[0.8rem] font-normal",
        ...
        day: cn(
          "group/day relative size-[var(--cell-size)] shrink-0 select-none p-0 text-center [&:first-child[data-selected=true]_button]:rounded-l-md [&:last-child[data-selected=true]_button]:rounded-r-md",
