...
export default function ConstructionLeadsPage() {
  ...
  const { leads, showSkeleton, refetch } = useInstantLeadsByType(LeadType.CONSTRUCTION);
  ...
  return (
    <main className="flex min-h-[calc(100vh-80px)] w-full flex-col gap-3 bg-theme-dark px-3 py-3 pt-16 sm:gap-4 sm:px-4 sm:py-4 md:px-8 md:py-6 lg:pt-6">
      <header className="flex flex-col gap-1">
        <h1 className="text-xl font-semibold text-theme-light sm:text-2xl">Construction Leads</h1>
        <p className="text-xs text-gray-400 sm:text-sm">
          Manage construction leads and opportunities.
        </p>
      </header>
        ...
        {showSkeleton ? (
          ...
          <div className="flex flex-1 items-center justify-center p-4">
            <div className="max-w-md rounded-xl border border-dashed border-theme-gray-subtle bg-theme-dark/80 px-4 py-8 text-center text-sm text-gray-400 sm:rounded-2xl sm:px-6 sm:py-10">
              <Icon name="mdi:tools" size={48} className="mx-auto mb-4 text-gray-500" />
              <p className="text-base font-medium text-gray-300">No construction leads found.</p>
      ...
      <Modal
        isOpen={isModalOpen}
        title="Create Construction Lead"
